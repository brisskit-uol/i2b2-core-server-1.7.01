...
import edu.harvard.i2b2.crc.loader.datavo.pdo.EidType;
import edu.harvard.i2b2.crc.loader.datavo.pdo.EidType.EventMapId;
...
public class EidDAO extends CRCLoaderDAO implements IEidDAO {
	...
	protected class TempEidInsert extends BatchSqlUpdate {
		...
		protected void insert(EidType eid) {
			...
			String encounterPatientIdSource = eid.getEventId().getPatientIdSource();
