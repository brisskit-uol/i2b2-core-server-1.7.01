...
import edu.harvard.i2b2.crc.loader.datavo.pdo.PidType;
import edu.harvard.i2b2.crc.loader.datavo.pdo.PidType.PatientMapId;
...
public class PidDAO extends CRCLoaderDAO implements IPidDAO {
	...
	public TempPidInsertHandler createTempPidInsert( String tempTableName ) {
		TempPidInsert 
			tempPidInsert = new TempPidInsert( getDataSource(),	tempTableName, this.getDbSchemaName() ) ;
